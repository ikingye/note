...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.e9a8095399044ae0ced2d04068335a6d5fa804b345a95ff1a5b0d1ea0b2b4a75.js',function(){input.required=false;search();});}
