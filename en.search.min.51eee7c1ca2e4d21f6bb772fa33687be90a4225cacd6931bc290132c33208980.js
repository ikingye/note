...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.98fd6b3e71e87deabd9cfacf1f491bf21aebbb62480ccb854d3f3a588d9c8b99.js',function(){input.required=false;search();});}
