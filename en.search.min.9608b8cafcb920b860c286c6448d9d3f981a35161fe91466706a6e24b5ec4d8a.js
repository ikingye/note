...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.532777be1560b3d27646cc6a401cca7f660e125312d1e8add10cf4a291572aee.js',function(){input.required=false;search();});}
