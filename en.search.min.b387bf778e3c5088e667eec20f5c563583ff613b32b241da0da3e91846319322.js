...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.c0838b98a4d394cfe9a60f0a6990724ec6ef79934f5e87a30a67d53cfadb3d9c.js',function(){input.required=false;search();});}
