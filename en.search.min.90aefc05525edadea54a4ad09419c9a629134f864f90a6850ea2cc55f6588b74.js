...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.e4dc60c4fe0a7bb23c423bf037509a8f330b28c31fb7e9aff8f80e3e47f5b67a.js',function(){input.required=false;search();});}
