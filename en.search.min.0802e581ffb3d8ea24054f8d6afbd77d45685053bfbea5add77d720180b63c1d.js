...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.7f19cf5d0300020a875035cc73393a408d75355d4a32d221184cf4b640ea4d67.js',function(){input.required=false;search();});}
