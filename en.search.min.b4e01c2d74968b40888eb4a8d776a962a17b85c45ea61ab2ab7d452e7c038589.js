...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.3d207c509fe09ffd0e8b564088e58a9dc5698671baf06f7e5a1b8d4f1f91b108.js',function(){input.required=false;search();});}
