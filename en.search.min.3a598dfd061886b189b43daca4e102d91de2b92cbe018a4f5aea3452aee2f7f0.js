...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.38fac89a0e5452d3d4119be562dd59a8a62153dcc870bc5d91a6beade6f55f8e.js',function(){input.required=false;search();});}
