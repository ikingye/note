...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.d70a5a9733d53fb1fdb8bd90a8b1b953592fa7e6dfbf029a8c002d6bd10f492c.js',function(){input.required=false;search();});}
