...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.2cc2679bb8080aaadc25c82a79a24324c3e29942b0cfe4f617d72fbdb0d257d6.js',function(){input.required=false;search();});}
