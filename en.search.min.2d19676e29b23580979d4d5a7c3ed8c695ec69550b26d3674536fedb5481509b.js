...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.5d0f952c04bc53d0875d6e00ed55fcfa9767ec96eb493a4760d5ac7dde4145f8.js',function(){input.required=false;search();});}
