...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.f1b92a0be7d4bf6f524ab0082a5698922170fbc7444ee61a27dd87327984f309.js',function(){input.required=false;search();});}
