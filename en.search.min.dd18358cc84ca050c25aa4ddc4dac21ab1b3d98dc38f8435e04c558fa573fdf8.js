...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.90bfcf352879e5a60bfa4d5ca119c3396b4daba91cd4ccbc444ecc133475b368.js',function(){input.required=false;search();});}
