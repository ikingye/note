...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.1663db7a28a1fec1960ddf406cd3f5ca43810401e38aa759cf63c715d7be8b69.js',function(){input.required=false;search();});}
