...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.098c1075de74c5ea72360aea5a9b0386c68ca52bcc076564611348b2822cb33c.js',function(){input.required=false;search();});}
