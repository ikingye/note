...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.f320beafa0f5a207d916829882ef0e3841662e45a5784ccadf564ed3d50d5b57.js',function(){input.required=false;search();});}
