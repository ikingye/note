...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.6b09c1f61a1410fa4655c21781f182b770afb84b7b5304599a9b81ec2f780ee0.js',function(){input.required=false;search();});}
