...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.833b1530fa415cc6ca7592d5a71ae9e9bbbaeceabe7332e45d4cbf256fdd0fd6.js',function(){input.required=false;search();});}
