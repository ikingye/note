...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.04e74f524a686d609c2185a8364dac40527d390612e67c1694970f16cfd0a769.js',function(){input.required=false;search();});}
