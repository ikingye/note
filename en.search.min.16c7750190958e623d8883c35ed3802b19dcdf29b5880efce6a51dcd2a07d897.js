...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.7a1fc38b6e0596f891a37580139caafbda567d8b815b16aa28dbefc836037df0.js',function(){input.required=false;search();});}
