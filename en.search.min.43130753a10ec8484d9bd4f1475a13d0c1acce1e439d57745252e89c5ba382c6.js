...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.cd2814a9476530bd781354e879571476f9c99d39db85591c866383a0431d298e.js',function(){input.required=false;search();});}
