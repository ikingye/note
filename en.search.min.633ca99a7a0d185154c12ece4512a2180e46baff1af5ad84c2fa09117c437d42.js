...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.43da3d4011980d950dca3a21aaad121a431fde227ffc5d6026b778635efe9360.js',function(){input.required=false;search();});}
