...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.344cfb8bdda84be61bb34a4841768af68fc54feeff1b07bd2329042de1d8d012.js',function(){input.required=false;search();});}
