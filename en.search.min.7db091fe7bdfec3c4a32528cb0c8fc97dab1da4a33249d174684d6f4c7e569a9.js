...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.37570afcf4d57feb97eda345e731c18172be85eb211db2e16f13e5c039e08679.js',function(){input.required=false;search();});}
