...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.f5930a252f683dfe1e81611d46b01166e27377e2d3e0779f6b56c732c2050f30.js',function(){input.required=false;search();});}
