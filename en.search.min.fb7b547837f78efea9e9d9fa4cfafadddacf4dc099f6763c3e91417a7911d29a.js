...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.b41a3a9173a8241d76a76846f2470511be30a85bfe60afdded29211eb28e7335.js',function(){input.required=false;search();});}
