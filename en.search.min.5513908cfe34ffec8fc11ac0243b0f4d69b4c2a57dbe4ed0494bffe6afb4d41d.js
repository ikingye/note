...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.1be5deb49ecfab719701f0d6a12c6794c9dc57db9719ad721b89e8da4d8b2ea2.js',function(){input.required=false;search();});}
