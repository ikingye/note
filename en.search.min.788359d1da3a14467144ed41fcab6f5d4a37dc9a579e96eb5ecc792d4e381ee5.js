...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.7afaa6c8e5db12ab3309d5677659877e156835ec3c0cf399b3a6a87b3090514d.js',function(){input.required=false;search();});}
