...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.4bfbbc6dcf3a49d07eb8801289b530e5880aa77b32181071631cc316ccaf9df4.js',function(){input.required=false;search();});}
