...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.0d6e9a6178895f569330f67d2abd40b054d1f52f96c2b5b8c9cb38ea9a748dbc.js',function(){input.required=false;search();});}
