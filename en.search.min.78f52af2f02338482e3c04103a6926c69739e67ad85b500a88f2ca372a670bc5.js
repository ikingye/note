...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.3c5d1f82b63fc399a6d76b85d8ddef5bcce6cc5854b8f03dea7fef032e64d703.js',function(){input.required=false;search();});}
