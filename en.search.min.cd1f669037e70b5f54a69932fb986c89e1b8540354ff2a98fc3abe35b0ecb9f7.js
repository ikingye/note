...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.cbfe2ceeeaa137abe1f298d02693b9809623ff6ce38c2a10c7a9d04d75e9bf13.js',function(){input.required=false;search();});}
