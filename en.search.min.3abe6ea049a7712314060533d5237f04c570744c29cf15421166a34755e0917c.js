...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.fafb52e3e3f58fccd094c105765c2fedbe2adfa8845cd33e92402d99af323d61.js',function(){input.required=false;search();});}
