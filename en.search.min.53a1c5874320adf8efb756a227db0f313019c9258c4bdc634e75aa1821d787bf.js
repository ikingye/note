...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.f90d8703c856348cd84f3cf5b0bca4ed6bbde602a3e5b9d50b91af2ea9c8fd37.js',function(){input.required=false;search();});}
