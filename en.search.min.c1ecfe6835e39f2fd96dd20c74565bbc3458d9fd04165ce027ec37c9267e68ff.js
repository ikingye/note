...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.d3f2d06ca97eb3dded63d94c74f03f92d4cba1309fc7b820d4794a8b4615548a.js',function(){input.required=false;search();});}
