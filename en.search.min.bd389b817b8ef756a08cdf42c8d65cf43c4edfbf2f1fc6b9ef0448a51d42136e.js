...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.622964126643451978217a9ffeb377292704b069c2dda66c103cfcacde3cf65b.js',function(){input.required=false;search();});}
