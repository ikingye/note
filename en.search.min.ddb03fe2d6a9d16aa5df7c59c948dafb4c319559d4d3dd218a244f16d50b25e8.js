...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.0840d23a32db4bfc8258c209f6970c684308bf163073600d5a0cb68e6887ee33.js',function(){input.required=false;search();});}
