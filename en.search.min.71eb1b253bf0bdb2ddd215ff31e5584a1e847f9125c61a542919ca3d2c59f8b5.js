...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.9f470a20bfdc3716910ea5ed6b6014406de1b987004ee807cc40420fd46aa600.js',function(){input.required=false;search();});}
