...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.c69818697eff542cc5f678296126864174c73490417fe0388daea7311b33d2be.js',function(){input.required=false;search();});}
