...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.49d15752cee1e362a7a091808663dd140fcc6547bf753fa329121371772d18c0.js',function(){input.required=false;search();});}
