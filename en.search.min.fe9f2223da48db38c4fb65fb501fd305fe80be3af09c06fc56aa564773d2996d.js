...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.38605bdb82b87654c46b93527913cc89f85e3638efcc46ed8b96b0519f5239ee.js',function(){input.required=false;search();});}
