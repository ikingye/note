...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.04edc4997fdecf7f9424364d571aa44d1a0a83068a3901aa158ca45212f2711e.js',function(){input.required=false;search();});}
