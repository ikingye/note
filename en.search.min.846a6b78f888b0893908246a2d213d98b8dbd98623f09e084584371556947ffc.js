...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.5ab99f823c8aa76d9dab2f01a4462b8952cd98d6d620b9288168795958fe607a.js',function(){input.required=false;search();});}
