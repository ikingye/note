...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.7aa8238f255d4482c567e3fa25effd23c31a5a9dcdb2883c63e623149c5c712f.js',function(){input.required=false;search();});}
