...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.3238ca10a10883f302114ff2812aa029053f3c65d9a546065540e699a9825a1c.js',function(){input.required=false;search();});}
