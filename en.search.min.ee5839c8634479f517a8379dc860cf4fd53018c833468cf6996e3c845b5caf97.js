...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.791f770deee5c2bc1892f070e73a67992899f965a1895d3a3d29dc949c01794f.js',function(){input.required=false;search();});}
