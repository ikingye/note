...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.01788e9baf6318b87e7402c7c7235f81f04f6283c833a4d05dcfaa5f58c46b22.js',function(){input.required=false;search();});}
