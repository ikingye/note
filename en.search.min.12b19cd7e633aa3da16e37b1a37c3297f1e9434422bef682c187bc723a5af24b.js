...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.a1e3be4dc105b5dfc2bd9bc983aa2dc75ac4db0866084eed59f3d97a767cbaa2.js',function(){input.required=false;search();});}
