...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.96d969c619ba234c6c9655cbe15a25f2ca4c91994154128210cfc28ed81171ac.js',function(){input.required=false;search();});}
