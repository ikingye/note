...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.36edaa1fd860bda2204072fe2cfa572331e0f51b2a37b94f3610fab78daff236.js',function(){input.required=false;search();});}
