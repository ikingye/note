...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.de75eec28b1b9b14640553eaf507c4a73feda56d4f3d2fab027d7bf163a8a006.js',function(){input.required=false;search();});}
