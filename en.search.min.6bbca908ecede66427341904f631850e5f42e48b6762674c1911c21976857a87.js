...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.aaf2c6bf4a6a1b40fa77fdcbb16e6b90fbaa37bc36d2a1a349f8e81fd6351dc0.js',function(){input.required=false;search();});}
