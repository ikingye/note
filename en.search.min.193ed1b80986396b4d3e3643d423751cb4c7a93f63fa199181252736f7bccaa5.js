...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.f67a4cd0902bd4798f9abf317b308df7c539102a85fa721f888438640417aa75.js',function(){input.required=false;search();});}
