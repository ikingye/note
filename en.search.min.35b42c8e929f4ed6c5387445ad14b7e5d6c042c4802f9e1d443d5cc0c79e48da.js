...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.5ea79d1d42200e5596214a56c722db615abd89426924e62ecffe8401ab60e2b7.js',function(){input.required=false;search();});}
