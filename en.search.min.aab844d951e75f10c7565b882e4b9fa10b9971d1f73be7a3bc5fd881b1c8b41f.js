...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.e97a531f7754a1fa5a88d455264ef86c9593330c1691980a1a86ff0006a1c8e9.js',function(){input.required=false;search();});}
