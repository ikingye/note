...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.e0932ec56cac8565f13dff4e657b9dea16f7997694cf61c67fd5b4e2dcebdf27.js',function(){input.required=false;search();});}
