...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.447919b9b15c6f4ac93075489465a1bd4b2343c8ec669897574a6c3e3f6e40a2.js',function(){input.required=false;search();});}
