...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.21c0bea7e2904dca2168dd7b244fc6406d40993a68c18dff231d7bf1b3fd86c6.js',function(){input.required=false;search();});}
