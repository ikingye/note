...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.6d8fce7f5aa629b7e967df1fb448319b0a37c4a3311f3a33051a21497de0e87c.js',function(){input.required=false;search();});}
