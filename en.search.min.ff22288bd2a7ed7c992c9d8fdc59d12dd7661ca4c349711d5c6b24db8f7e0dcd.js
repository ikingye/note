...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.14825a6b37cd912ac312e66c401875b3bb59bfcb8629276086b4120388978ef2.js',function(){input.required=false;search();});}
