...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.24c78bb591b7a05c842ef54c9e591564fe46ff4e53c6f745db3b51ec1976f4a9.js',function(){input.required=false;search();});}
