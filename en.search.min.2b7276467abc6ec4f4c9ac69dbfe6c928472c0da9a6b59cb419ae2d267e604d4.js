...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.2858be237ad4bd8413438354360cf4a70b2f7e078c805fbd14f5765c4c9e9a07.js',function(){input.required=false;search();});}
