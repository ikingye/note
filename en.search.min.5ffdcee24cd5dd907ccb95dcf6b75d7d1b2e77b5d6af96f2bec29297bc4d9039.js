...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.457b4dbcb99237e4c98b47657650592a8627d22385099be13076557820901d61.js',function(){input.required=false;search();});}
