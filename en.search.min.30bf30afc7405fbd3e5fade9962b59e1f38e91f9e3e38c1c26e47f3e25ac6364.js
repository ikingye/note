...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.cd32e63f283c919551a572972df166dae48b1568e76901777931a50b1e907960.js',function(){input.required=false;search();});}
