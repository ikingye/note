...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.d7eafdc623c8c80d8d7e7c0bb5fde7550d9802f85fdecb0ae95ba6bc686fa62d.js',function(){input.required=false;search();});}
