...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.72dd3e530819cb71ed4d1d14663166fa010c4461d01d4dc3ded085680f0c4755.js',function(){input.required=false;search();});}
