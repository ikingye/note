...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.3024a6f0fd8f417a1918ea378aff899feb503e45bcdb547de87fb2ab5f1755e5.js',function(){input.required=false;search();});}
