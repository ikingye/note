...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.2cd23fac3d38043590ea8a918cb16be782b4ed84f9f34e5d77360c99869993d1.js',function(){input.required=false;search();});}
