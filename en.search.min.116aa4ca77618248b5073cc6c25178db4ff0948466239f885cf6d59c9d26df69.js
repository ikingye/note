...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.441aca1a553ec96559c820fbe5840cf0d9ee814ed145dfd8fd40b35dc3405474.js',function(){input.required=false;search();});}
