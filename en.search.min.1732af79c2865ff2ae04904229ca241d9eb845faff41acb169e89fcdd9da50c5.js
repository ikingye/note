...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.23b979520c1f370d1c39ef9fe65088d3104197e7fa8315264f4ba18c4160bf05.js',function(){input.required=false;search();});}
