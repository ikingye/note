...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.6b82c565e6803c0212a8cf97b04eb29b68f56f6192a1dbb4c79112dec1dec67b.js',function(){input.required=false;search();});}
