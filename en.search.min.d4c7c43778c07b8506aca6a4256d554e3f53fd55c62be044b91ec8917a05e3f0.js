...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.fec6ac2b902be9df0f139502183cffc384e8ecee51b55af4b731b68a8fe097b5.js',function(){input.required=false;search();});}
