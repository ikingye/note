...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.4598f2174fd4acbeff4039f264c1ce43641353a885c39deee488419364ae9d77.js',function(){input.required=false;search();});}
